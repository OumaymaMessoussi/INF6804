...
def sgm(left, right, descriptor, distance, descriptor_size, num_elements, num_orientations, max_disp):
    """
    ...
    # if left.shape[0] > 800:
        # left = cv2.resize(left, (left.shape[0]//2, left.shape[1]//2))
        # right = cv2.resize(right, (right.shape[0]//2, right.shape[1]//2))
        # print('Image size after resize: '+str(left.shape))
